...
c.execute('''CREATE TABLE IF NOT EXISTS pogoda_warszawa
...
url = f'http://api.openweathermap.org/data/2.5/forecast?q=Warsaw,pl&exclude=current,minutely,hourly,alerts&units=metric&appid={api_key}'
...
for i in range(5):
    ...
    c.execute("INSERT INTO pogoda_warszawa (data, temperatura, wilgotnosc, opis) VALUES (?, ?, ?, ?)",
